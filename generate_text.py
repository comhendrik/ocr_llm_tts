...
def tts_to_wav(voice: PiperVoice, text: str, out_path: str):
    with wave.open(out_path, "wb") as wav_file:
        voice.synthesize_wav(text, wav_file)

def tts_live(voice: PiperVoice, text: str):
